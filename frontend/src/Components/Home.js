...
const items = [
	...
	{
		src: 'http://localhost:8080/files/G-2.jpg',
		altText: 'Espai 2',
		caption: 'Espai 2'
	},
	{
		src: 'http://localhost:8080/files/G-1.jpg',
		altText: 'Espai 3',
		caption: 'Espai 3'
	}
];
	...
	render() {
		...
		return (
			<div className="bg-white">								
                ...
                <img src="https://ichef.bbci.co.uk/news/800/cpsprodpb/F403/production/_109476426_jheison3.png.webp" className="mx-auto d-block " alt="Imatge Oficina" height="600px" />
