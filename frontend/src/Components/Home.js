...
class Home extends Component {
	...
	render() {
		...
		const Marker = props => {
			return (<img style={greatPlaceStyle} className={"marker-map"} height='91' width='78' src={logo} alt={"Localitzación"} />)
		}

		return (
			<div className="typography">
				<h1 className="text-white text-center bg-degradat p-3">Coworking Manacor</h1>
				<div className="bg-white pb-5">
					<Col sm={9} className="mx-auto my-5">
