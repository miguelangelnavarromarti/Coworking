...
class IconoLogin extends Component {
    ...
    return  (<React.Fragment>              
                    <Col className='text-center mt-3'>
                      <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" className="bi bi-person-circle mx-2" viewBox="0 0 16 16" aria-label="Area Cliente">
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" className="bi bi-person-x-fill mx-2" viewBox="0 0 16 16">
        ...
        return  (<React.Fragment> 
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="black" className="bi bi-door-open mx-2" viewBox="0 0 16 16" aria-label="Login">
